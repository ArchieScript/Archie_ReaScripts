...
--=======================================================]]
   ...
   TrackFX_GetFXNameEx = Arc_Module.TrackFX_GetFXNameEx;
    ...
    function Arc_Module.DeleteEnvelopeRangeEx(env,time1,time2,Undo);
    ...
    DeleteEnvelopeRangeEx = Arc_Module.DeleteEnvelopeRangeEx
    function Arc_Module.Convert_Env_ValueInValueAndInPercent_SWS(envelope,valPoint,PerVal);
    ...
    Convert_Env_ValueInValueAndInPercent_SWS = Arc_Module.Convert_Env_ValueInValueAndInPercent_SWS;
            ...
            if i == -1 then;
                ...
                for i2 = 1,CountEnvPoint do;
                    ...
                    if time >= m(time1) and time <= m(time2) --[[and i == -1 or i>=0]] then;
                        local ScalingPre = reaper.GetEnvelopeScalingMode(ENV);
                        if ScalingPre == 1 then;
                            value = reaper.ScaleFromEnvelopeMode(ScalingPre,value);
                        end;
                        ...
                        local ScalingPost = reaper.GetEnvelopeScalingMode(ENV_NEW);
                        if ScalingPost == 1 then;
                            value = reaper.ScaleToEnvelopeMode(ScalingPost,value)
                        end;
    ...
    CopyMove_EnvTr_PointsInRangeOfTime_SWS = Arc_Module.CopyMove_EnvTr_PointsInRangeOfTime_SWS;
