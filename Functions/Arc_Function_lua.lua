...
--=======================================================]]
   ...
   --====End===============End===============End===============End===============End====
    ...
    ----
    -- *
    -- samples_skip - если установить в ноль, то будет просчитываться каждый семпл.
    -- при SampleRate (44100) деленном на сто, получается 441, это значет что функция будет прощитывать каждый 441 семпл, а т.е. (1,443,885,1327,1769 и т.д.), 
    -- в итоге получится, что в секунду обработается сто семплов.
    -- Все семплы в плюсе. Sample_min,Sample_max - это если айтем стерео или мультиканальный, 
    -- то выбирается из всех каналов одно максимальное и одно минимальное значения семпла.
    -- https://avatars.mds.yandex.net/get-pdb/2724140/8e126408-364f-4e81-bbf7-20e885d9f99a/s1200
    --====End===============End===============End===============End===============End====
