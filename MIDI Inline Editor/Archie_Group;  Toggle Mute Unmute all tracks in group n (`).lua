--[[
   ...
   * Provides:    
   *              [main] . > Toggle Mute Unmute all tracks in group 01 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 02 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 03 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 04 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 05 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 06 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 07 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 08 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 09 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 10 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 11 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 12 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 13 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 14 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 15 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 16 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 17 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 18 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 19 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 20 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 21 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 22 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 23 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 24 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 25 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 26 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 27 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 28 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 29 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 30 (`).lua
   *              [main] . > Toggle Mute Unmute all tracks in group 31 (`)
   *              [main] . > Toggle Mute Unmute all tracks in group 32 (`)
   * Changelog:   
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 01";
       else;
           ...
           Undo = "Unmute all tracks in group 01";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 01",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
