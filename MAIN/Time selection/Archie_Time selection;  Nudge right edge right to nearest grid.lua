--[[
   ...
   * Description: Nudge right edge right to nearest grid
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Nudge right edge right to nearest grid
   * О скрипте:   подтолкнуть правый край вправо к ближайшей сетке
   * GIF:         ---
...
--===========================================================================================]]
    ...
    if ToggleGridLines == 1 then;
        ...
        local Grid = reaper.BR_GetNextGridDivision(endLoop);
        reaper.GetSet_LoopTimeRange(1,0,startLoop,Grid,0);

        reaper.Undo_EndBlock("Nudge right edge right to nearest grid",-1);
