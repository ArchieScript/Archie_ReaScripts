--[[
   ...
   * Provides:
   *              [main] . > Archie_Options; Smart Multi script(Button 01).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 02).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 03).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 04).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 05).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 06).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 07).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 08).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 09).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 10).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 11).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 12).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 13).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 14).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 15).lua
   *              [main] . > Archie_Options; Smart Multi script(Button 16).lua
   * Changelog:
   *              +  initialе / v.1.0 [12.11.18]
   ...
   ----------------------------------------------------------------------------------------||
   + Reaper v.5.962 +           --| http://www.reaper.fm/download.php                      ||
   + SWS v.2.9.7 +              --| http://www.sws-extension.org/index.php                 ||
   - ReaPack v.1.2.2 +          --| http://reapack.com/repos                               ||
   - Arc_Function_lua v.1.1.6 + --| Repository - Archie-ReaScripts  http://clck.ru/EjERc   ||
