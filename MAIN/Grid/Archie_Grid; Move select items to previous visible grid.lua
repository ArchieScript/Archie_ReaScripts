--[[
   ...
   *
   * Category:    Grid
   * Description: Move select items to previous visible grid
   * Author:      Archie
   * Version:     1.0
   * Описание:    Переместить выбранные элементы к предыдущей видимой сетке
...
--]]
    ...
    reaper.PreventUIRefresh(-1);
    reaper.Undo_EndBlock('Move select items to previous visible grid',-1);
