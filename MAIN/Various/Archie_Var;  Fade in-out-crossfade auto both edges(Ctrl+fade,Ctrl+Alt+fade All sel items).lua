--[[
   ...
   *
   * Category:    Various
   * Description: Fade in-out-crossfade auto both edges(Ctrl+fade,Ctrl+Alt+fade All sel items)
   * Author:      Archie
   * Version:     1.0
   * AboutScript: ---
   * О скрипте:   Повышение затухание автоматически оба края (Ctrl+fade,Ctrl+Alt+fade все выделенные элементы)
   * GIF:         ---
   * Website:     http://forum.cockos.com/showthread.php?t=212819
   *              http://rmmedia.ru/threads/134701/
   * Donation:    http://money.yandex.ru/to/410018003906628
   * Customer:    Iskander(RMM)
   * Gave idea:   Iskander(RMM)
   * Changelog:   v.1.0 [02.07.19]
   *                  + initialе
