--[[
   ...
   *
   * Category:    Various
   * Description: Var; Snap position of selected items to nearest grid.lua
   * Author:      Archie
   * Version:     1.02
...
--]]
    ...
    if UNDO then;
        ...
        reaper.Undo_EndBlock("Snap position of selected items to nearest grid",-1);
        reaper.UpdateArrange();
    else;
        no_undo();
    end;
