--[[
   * Category:    Envelope
   * Description: Show all envelopes containing points or auto items
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Show all envelopes containing points or auto items
   * О скрипте:   Показать все конверты, содержащие точки или авто элементы
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [05042019]
   ...
   =======================================================================================]]
    ...
    reaper.PreventUIRefresh(-1);
    reaper.Undo_EndBlock("Show all envelopes containing points or auto items",-1);