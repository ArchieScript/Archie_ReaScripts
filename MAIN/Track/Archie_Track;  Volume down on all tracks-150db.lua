--[[
   * Category:    Track
   * Description: Volume down on all tracks -150db
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Volume down on all tracks -150db
   * О скрипте:   Уменьшение громкости на всех треках -150 дБ
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [02042019]
   ...
   ========================================================================================]]
    ...
    reaper.Undo_EndBlock("Volume down on all tracks-150db",-1);
