--[[
   * Category:    Track
   * Description: Set Volume all tracks to -6.0 dB
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Set Volume all tracks to -6.0 dB
   * О скрипте:   Установите громкость всех дорожек на -6.0 dB
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [02042019]
   ...
   ========================================================================================]]
    ...
    reaper.Undo_EndBlock("Set Volume all tracks to -6.0 dB",-1);
