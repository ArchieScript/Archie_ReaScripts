--[[ 
   ...
   * 
   * Category:    Track 
   * Description: Track; Hide selected tracks in TCP and MCP.lua 
   * Author:      Archie 
   * Version:     1.0 
  ...
  --====================================================================================== 
    ...
    for i = 1,CountSelTracks do; 
        ...
        if VisibM or VisibT then; 
            ...
            if VisibT then; 
                reaper.SetMediaTrackInfo_Value(trackSel,'B_SHOWINTCP',0); 
            end; 
        end; 
    end; 
    ...
    if UNDO then; 
        ...
        reaper.PreventUIRefresh(-1); 
        reaper.Undo_EndBlock('Hide selected tracks in TCP and MCP',-1); 
    else; 
        no_undo(); 
    end; 
