--[[ NEW INSTANCE
   * Category:    Track
   * Description: Unmute all visible track in TCP and MCP
   * Author:      Archie
   * Version:     1.04
   * AboutScript: ---
   * О скрипте:   Включить звук на всех видимых дорожках в TCP и MCP
   * GIF:         ---
   ...
   *                  + initialе
    ...
    if UNDO then;
        reaper.Undo_EndBlock("Unmute all visible track in TCP and MCP",-1);
    else;
        no_undo();
    end;
    --=========================================
