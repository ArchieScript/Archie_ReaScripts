--[[
   ...
   *
   * Category:    Track
   * Description: Track; Go to next track - track solo in solo exclusive(skip minimized folders).lua
   * Author:      Archie
   * Version:     1.0
...
--]]
    ...
    if LastTouchedTrack then;
        ...
        'Archie_Track; Select next tracks(skip minimized folders)(`).lua';
        dofile(dof); 
        -----------------
    ...
    local title = 'Go to next track - track solo in solo exclusive(skip minimized folders)';
