--[[
   * Category:    Track
   * Description: Cycle Volume down on all tracks by 1 db
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Cycle Volume down on all tracks by 1 db
   * О скрипте:   Цикл громкости вниз на всех дорожках на 1 дБ
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [02042019]
   ...
   ========================================================================================]]
    ...
    for i = 1, CountTrack do;
	   ...
	   local vol = 20 * math.log(reaper.GetMediaTrackInfo_Value(Track,"D_VOL"),10);
	    reaper.SetMediaTrackInfo_Value(Track,"D_VOL",(10^((vol-1)/20)));
    end;
    
    reaper.Undo_EndBlock("Cycle Volume down on all tracks by 1 db",-1);
