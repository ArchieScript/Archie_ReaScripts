--[[ 
   * Category:    Track 
   * Description: Volume down on all tracks by 1 db 
   * Author:      Archie 
   * Version:     1.0 
   * AboutScript: Volume down on all tracks by 1 db 
   * О скрипте:   Уменьшение громкости на всех треках на 1 дБ 
   * GIF:         --- 
   ...
   *              +  initialе / v.1.0 [02042019] 
   ...
   ========================================================================================]] 
    ...
    reaper.Undo_EndBlock("Volume down on all tracks by 1 db",-1); 
