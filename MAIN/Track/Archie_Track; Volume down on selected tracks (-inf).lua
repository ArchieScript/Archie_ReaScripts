--[[
   * Category:    Track
   * Description: Volume down on selected tracks (-inf)
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Volume down on selected tracks (-inf)
   * О скрипте:   Уменьшение громкости на выбранных треках (-inf)
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [02042019]
   ...
   ========================================================================================]]
    ...
    reaper.Undo_EndBlock("Volume down on selected tracks (-inf)",-1);
