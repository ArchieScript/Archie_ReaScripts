--[[ 
   * Category:    Track 
   * Description: Volume up on selected tracks by 1 dB 
   * Author:      Archie 
   * Version:     1.0 
   * AboutScript: Volume up on selected tracks by 1 dB 
   * О скрипте:   Увеличение громкости на выбранных дорожках на 1 дБ 
   * GIF:         --- 
   ...
   *              +  initialе / v.1.0 [02042019] 
   ...
   ========================================================================================]] 
    ...
    reaper.Undo_EndBlock("Volume up on selected tracks by 1 dB",-1); 
