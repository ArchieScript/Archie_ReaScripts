--[[
   * Category:    Track
   * Description: Cycle Volume up on all tracks by 1 dB
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Cycle Volume up on all tracks by 1 dB
   * О скрипте:   Цикл громкости вверх на всех дорожках на 1 дБ
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [02042019]
   ...
   ========================================================================================]]
    ...
    reaper.Undo_EndBlock("Cycle Volume up on all tracks by 1 dB",-1);
