--[[
   * Category:    Track
   * Description: Set Volume selected tracks to -6.0 dB
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Set Volume selected tracks to -6.0 dB
   * О скрипте:   Установите громкость выбранных дорожек на -6.0 dB
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [02042019]
   ...
   ========================================================================================]]
    ...
    for i = 1, CountSelTrack do;
	   ...
	   reaper.SetMediaTrackInfo_Value(SelTrack,"D_VOL",(10^(-6/20)));
    end;

    reaper.Undo_EndBlock("Set Volume selected tracks to -6.0 dB",-1);
