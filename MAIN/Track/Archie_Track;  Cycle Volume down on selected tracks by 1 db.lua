--[[
   * Category:    Track
   * Description: Cycle Volume down on selected tracks by 1 db
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Cycle Volume down on selected tracks by 1 db
   * О скрипте:   Цикл громкости вниз на выбранных дорожках на 1 дБ
   * GIF:         ---
   ...
   *              +  initialе / v.1.0 [02042019]
   ...
   ========================================================================================]]
    ...
    reaper.Undo_EndBlock("Cycle Volume down on selected tracks by 1 db",-1);
