--[[
   ...
   * Changelog:   +  initialе / v.1.0 [24.01.2019]
   ...
   + Arc_Function_lua v.2.1.9 -| Repository - Archie-ReaScripts  http://clck.ru/EjERc |и выше)|
...
--===========================================================================================]]
    ...
    if not Arc.VersionArc_Function_lua("2.1.9",Fun,"")then Arc.no_undo() return end;--==================================== FUNCTION MODULE FUNCTION ==========
    --==================================▲=▲=▲=================================================================================================================
