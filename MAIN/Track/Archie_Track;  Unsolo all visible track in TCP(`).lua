--[[
   * Category:    Track
   * Description: Unsolo all visible track in TCP
   * Author:      Archie
   * Version:     1.03
   * AboutScript: ---
   * О скрипте:   ---
   ...
   *                  + initialе
    ...
    --=========================================
    local function AnyTrackSolo(proj);
    ...
    if UNDO then;
        reaper.Undo_EndBlock("Unsolo all visible track in TCP",-1);
    else;
        no_undo();
    end;
    --=========================================
