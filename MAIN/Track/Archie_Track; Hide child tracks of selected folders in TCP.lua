--[[
   ...
   *
   * Category:    Track
   * Description: Track; Hide child tracks of selected folders in TCP.lua
   * Author:      Archie
   * Version:     1.03
   * Описание:    Трек; Скрыть дочерние треки выбранных папок в TCP
...
--]]
  ...
  --======================================================================================
    ...
    if UNDO then;
        ...
        reaper.PreventUIRefresh(-1);
        reaper.Undo_EndBlock('Hide child tracks of selected folders in TCP',-1);
    else;
        no_undo();
    end;
