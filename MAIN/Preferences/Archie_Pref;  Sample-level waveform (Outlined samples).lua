--[[              
   ...
   * Description: Sample-level waveform (Outlined samples)
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Preferences -> Peaks/Waveforms -> Name Script
   * О скрипте:   Образец-уровень сигнала (см. образцы)
...
--]] 
    ...
    -- / Sample-level waveform (Outlined samples) / --
    if ConfigVar ~= 4 then;
        reaper.SNM_SetIntConfigVar("sampleedges",4);
    end;
