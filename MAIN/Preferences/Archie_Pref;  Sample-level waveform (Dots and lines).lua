--[[              
   ...
   * Description: Sample-level waveform (Dots and lines)
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Preferences -> Peaks/Waveforms -> Name Script
   * О скрипте:   Форма волны на уровне образца (точки и линии)
...
--]] 
    ...
    -- / Sample-level waveform (Dots and lines) / --
    if ConfigVar ~= 1 then;
        reaper.SNM_SetIntConfigVar("sampleedges",1);
    end;
