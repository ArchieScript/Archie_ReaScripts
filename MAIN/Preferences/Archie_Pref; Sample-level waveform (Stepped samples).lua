--[[
   ...
   * Description: Sample-level waveform (Stepped samples)
   * Author:      Archie
   * Version:     1.02
   * AboutScript: Preferences -> Peaks/Waveforms -> Name Script
   * О скрипте:   Образец-уровень сигнала (Ступенчатые образцы)
...
--]]
    ...
    -- / Sample-level waveform (Stepped samples) / --
    if ConfigVar ~= 8 then;
        reaper.SNM_SetIntConfigVar("sampleedges",8);
    end;
