--[[
   ...
   *
   * Description: Mixer;  Reset view selected tracks MCP by master track
   * Author:      Archie
   * Version:     1.0
   * Описание:    Микшер;  Сбросить вид невыбранных дорожек MCP по главной дорожке
...
--]]
    ...
    if trHeight and Fxparam and trInsertFx then;
        ...
        reaper.PreventUIRefresh(-1);
        reaper.Undo_EndBlock('Reset view unselected tracks MCP by master track',-1);
    end;
