--[[
   * Category:    Item
   * Description: Switch item source file to previous in folder restore original size (only Audio)
   * Author:      Archie-
   * Version:     1.01
   * AboutScript: Switch item source file to previous in folder restore original size (only Audio)
...
--===========================================================================================]]
    ...
    if Undo == "Active" then;
        reaper.Undo_EndBlock("Switch item source file to previous in folder restore original size (only Audio)",-1);
    else;
        Arc.no_undo();
    end;
    ----
