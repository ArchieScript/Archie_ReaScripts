--[[
   ...
   *
   * Category:    Item
   * Description: Set in selected items CC shape Fast start
   * Author:      Archie
   * Version:     1.0
   * Описание:    Установить в выбранных элементах CC форму Fast start
...
--]] 
    ...
    for it = 1,reaper.CountSelectedMediaItems(0) do;
        ...
        while true do;
            ...
            if retval then;
                reaper.MIDI_SetCCShape(take,i-1,3,beztension,true);
            else;
                break;
            end;
        end;
