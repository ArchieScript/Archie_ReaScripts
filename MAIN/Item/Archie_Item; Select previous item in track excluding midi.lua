--[[
   ...
   *
   * Category:    Item
   * Description: Select previous item in track excluding midi
   * Author:      Archie
   * Version:     1.02
   * Описание:    Выберите предыдущий элемент в треке, исключая midi
...
--]]
    ...
    reaper.PreventUIRefresh(1);
    reaper.Undo_EndBlock('Select previous item in track excluding midi',-1);
