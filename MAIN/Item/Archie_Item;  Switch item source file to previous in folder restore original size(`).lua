--[[
   * Category:    Item
   * Description: Switch item source file to previous in folder restore original size
   * Author:      Archie
   * Version:     1.02
   * AboutScript: Switch item source file to previous in folder restore original size
   * О скрипте:   Переключить исходный файл элемента на предыдущий в папке восстановить исходный размер
...
--===========================================================================================]]
    ...
    if Undo == "Active" then;
        reaper.Undo_EndBlock("Switch item source file to previous in folder restore original size",-1);
    else;
        Arc.no_undo();
    end;
    ----
