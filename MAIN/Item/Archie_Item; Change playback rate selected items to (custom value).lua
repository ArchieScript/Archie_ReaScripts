--[[ 
   ...
   * 
   * Category:    Item 
   * Description: Change playback rate selected items to (custom value) 
   * Author:      Archie 
   * Version:     1.0 
...
--]] 
    ...
    local ret = tonumber(reaper.GetExtState(section,"PLAY_RATE_IT_CUSTOM_VALUE"))or 1; 
