--[[
   ...
   *
   * Category:    Item
   * Description: Select Next item in track only midi
   * Author:      Archie
   * Version:     1.0
   * Описание:    Выберите следующий пункт в треке только midi
...
--]]
    ...
    reaper.PreventUIRefresh(1);
    reaper.Undo_EndBlock('Select Next item in track only midi',-1);
