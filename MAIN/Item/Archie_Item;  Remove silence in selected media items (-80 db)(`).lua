--[[
   * Category:    Item
   * Description: Remove silence in selected media items (-80 db)
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Remove silence in selected media items (-80 db)
   * О скрипте:   Удалить тишину в выбранных элементах мультимедиа (-80 дБ)
   * GIF:         ---
   ...
   * Customer:    --- (---)
   * Gave idea:   --- (---)
   * Changelog:   +  initialе / v.1.0 [10.01.2019]
==============================================================================================
...
--===========================================================================================]]
    ...
    if Undo then;
        reaper.Undo_EndBlock("Remove silence in selected media items (-80 db)",-1);
    else;
        Arc.no_undo();
    end;
