--[[
   ...
   *
   * Category:    Item
   * Description: Item; Select only items in selected tracks from cursor to end of project.lua
   * Author:      Archie
   * Version:     1.0
...
--]]
    ...
    if UNDO then;
        ...
        reaper.Undo_EndBlock('Select only items in selected tracks from cursor to end of project',-1);
    else;
        no_undo();
    end;
