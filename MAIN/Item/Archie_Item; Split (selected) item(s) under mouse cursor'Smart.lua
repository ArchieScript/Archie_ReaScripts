...
--=============================================================================================]]
    ...
    local function Split_Item_Unsel(item,Pos,Val_Fade_In_Out, Length_Item,Unselected_rest);  
        ...
        local SelIt = reaper.GetMediaItemInfo_Value( item, "B_UISEL")
        ...
        return TrackNumber,Split,item,SelIt;
    end;
    --=====================================;
    ...
    local name_script = "Split selected item under mouse cursor'Smart"
    ...
    local TrackNumber,Split,item,SelIt = Split_Item_Unsel(item,Pos,Val_Fade_In_Out, Length_Item,Unselect_All_Rest_Items);
                    ...
                    for i2 = 1,CountTrItems do;
                        ...
                        if pos <= Pos and len + pos >= Pos then;
                            if reaper.GetMediaItemInfo_Value( item, "B_UISEL")== 1 then;
                                Split_Item_Unsel (item,Pos,Val_Fade_In_Out, Length_Item,Unselect_All_Rest_Items);
                                break;
                            end;
                        else;
                            if Unselect_All_Rest_Items == 1 then;
