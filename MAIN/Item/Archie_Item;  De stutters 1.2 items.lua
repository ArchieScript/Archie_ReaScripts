--[[
   ...
   *
   * Category:    Item
   * Description: De stutters 1.2 items
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Use with Stutter 1.2 items
   * О скрипте:   Использовать с Stutter 1.2 items
   * GIF:         ---
   ...
   *                  + initialе
    ...
    if Undo then;
        reaper.Undo_EndBlock("De Stutters 1/2 items",-1);
    else;
        no_undo();
    end;