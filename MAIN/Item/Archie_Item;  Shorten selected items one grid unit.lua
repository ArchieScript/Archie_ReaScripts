--[[
   ...
   *
   * Category:    Item
   * Description: Shorten selected items one grid unit
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Shorten selected items one grid unit
   *              Lengthen selected items one grid unit*
   * О скрипте:   Сократить выбранные элементы на одну единицу сетки
   *              Удлинить выбранные элементы на одну единицу сетки*
   * GIF:         ---
