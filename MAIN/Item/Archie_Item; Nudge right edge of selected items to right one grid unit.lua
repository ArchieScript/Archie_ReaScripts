--[[
   ...
   *
   * Category:    Item
   * Description: Nudge right edge of selected items to right one grid unit
   * Author:      Archie
   * Version:     1.02
   * AboutScript: Nudge right edge of selected items to right one grid unit
   *              Nudge right edge of selected items to left one grid unit*
   * О скрипте:   Сдвиньте правый край выделенных элементов вправо на одну единицу сетки
   *              Сдвиг правого края выделенных элементов влево на одну единицу сетки*
   * GIF:         ---
...
--]]
    ...
    reaper.Undo_EndBlock("Nudge right edge of selected items to right one grid unit",-1);
    reaper.PreventUIRefresh(-1);
