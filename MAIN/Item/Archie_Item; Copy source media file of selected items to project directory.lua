--[[
   ...
   *
   * Category:    Item
   * Description: Copy source media file of selected items to project directory (all take)
   * Author:      Archie
   * Version:     1.03
   * AboutScript: ---
   * О скрипте:   Скопировать исходный медиа файл у выбранных элементов в каталог проекта (все тейки)
   * GIF:         ---
