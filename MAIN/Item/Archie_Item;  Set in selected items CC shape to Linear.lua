--[[
   ...
   *
   * Category:    Item
   * Description: Set in selected items CC shape Linear
   * Author:      Archie
   * Version:     1.02
   * Описание:    Установить в выбранных элементах CC форму Linear
...
--]] 
    ...
    for it = 1,reaper.CountSelectedMediaItems(0) do;
        ...
        while true do;
            ...
            if retval then;
                reaper.MIDI_SetCCShape(take,i-1,1,beztension,true);
            else;
                break;
            end;
        end;
