--[[
   ...
   *
   * Category:    Item
   * Description: Set in selected items CC shape Fast end
   * Author:      Archie
   * Version:     1.02
   * Описание:    Установить в выбранных элементах CC форму Fast end
...
--]]
    ...
    for it = 1,reaper.CountSelectedMediaItems(0) do;
        ...
        while true do;
            ...
            if retval then;
                reaper.MIDI_SetCCShape(take,i-1,4,beztension,true);
            else;
                break;
            end;
        end;
