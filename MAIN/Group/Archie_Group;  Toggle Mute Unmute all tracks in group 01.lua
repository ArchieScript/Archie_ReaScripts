--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 01
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 01
   * О скрипте:   Переключить Mute Unmute все треки в группе 01
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40804); -- Select all tracks in group 01
    ---------------------------------------------------
    if SelMaster ~= 0 then;
