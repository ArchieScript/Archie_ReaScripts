--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 18
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 18
   * О скрипте:   Переключить Mute Unmute все треки в группе 18
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40821); -- Select all tracks in group 18
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 18";
       else;
           ...
           Undo = "Unmute all tracks in group 18";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 18",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
