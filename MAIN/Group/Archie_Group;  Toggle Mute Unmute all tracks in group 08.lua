--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 08
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 08
   * О скрипте:   Переключить Mute Unmute все треки в группе 08
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40811); -- Select all tracks in group 08
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 08";
       else;
           ...
           Undo = "Unmute all tracks in group 08";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 08",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
