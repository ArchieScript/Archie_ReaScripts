--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 28
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 28
   * О скрипте:   Переключить Соло Unsolo все треки в группе 28
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40831); -- Select all tracks in group 28
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 28";
       else;
           ...
           Undo = "Unsolo all tracks in group 28";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 28",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
