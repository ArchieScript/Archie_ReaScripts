--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 31
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 31
   * О скрипте:   Переключить Соло Unsolo все треки в группе 31
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40834); -- Select all tracks in group 31
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 31";
       else;
           ...
           Undo = "Unsolo all tracks in group 31";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 31",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
