--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 16
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 16
   * О скрипте:   Переключить Mute Unmute все треки в группе 16
   * GIF:         ---
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 16";
       else;
           ...
           Undo = "Unmute all tracks in group 16";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 16",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
