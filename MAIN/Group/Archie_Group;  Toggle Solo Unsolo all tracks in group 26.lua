--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 26
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 26
   * О скрипте:   Переключить Соло Unsolo все треки в группе 26
   * GIF:         ---
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 26";
       else;
           ...
           Undo = "Unsolo all tracks in group 26";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 26",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
