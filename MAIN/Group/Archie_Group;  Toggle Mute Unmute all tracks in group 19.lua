--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 19
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 19
   * О скрипте:   Переключить Mute Unmute все треки в группе 19
   * GIF:         ---
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 19";
       else;
           ...
           Undo = "Unmute all tracks in group 19";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 19",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
