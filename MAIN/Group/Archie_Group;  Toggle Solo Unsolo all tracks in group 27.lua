--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 27
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 27
   * О скрипте:   Переключить Соло Unsolo все треки в группе 27
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40830); -- Select all tracks in group 27
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 27";
       else;
           ...
           Undo = "Unsolo all tracks in group 27";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 27",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
