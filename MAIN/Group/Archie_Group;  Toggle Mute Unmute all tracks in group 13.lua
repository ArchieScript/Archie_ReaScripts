--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 13
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 13
   * О скрипте:   Переключить Mute Unmute все треки в группе 13
   * GIF:         ---
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 13";
       else;
           ...
           Undo = "Unmute all tracks in group 13";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 13",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
