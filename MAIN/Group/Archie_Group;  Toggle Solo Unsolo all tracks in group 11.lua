--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 11
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 11
   * О скрипте:   Переключить Соло Unsolo все треки в группе 11
   * GIF:         ---
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 11";
       else;
           ...
           Undo = "Unsolo all tracks in group 11";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 11",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
