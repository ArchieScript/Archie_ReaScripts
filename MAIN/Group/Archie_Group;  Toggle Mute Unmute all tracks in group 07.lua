--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 07
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 07
   * О скрипте:   Переключить Mute Unmute все треки в группе 07
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40810); -- Select all tracks in group 07
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 07";
       else;
           ...
           Undo = "Unmute all tracks in group 07";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 07",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
