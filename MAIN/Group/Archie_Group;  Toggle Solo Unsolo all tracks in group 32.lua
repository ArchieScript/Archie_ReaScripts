--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 32
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 32
   * О скрипте:   Переключить Соло Unsolo все треки в группе 32
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40835); -- Select all tracks in group 32
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 32";
       else;
           ...
           Undo = "Unsolo all tracks in group 32";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 32",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
