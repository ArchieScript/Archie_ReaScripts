--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 06
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 06
   * О скрипте:   Переключить Mute Unmute все треки в группе 06
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40809); -- Select all tracks in group 06
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 06";
       else;
           ...
           Undo = "Unmute all tracks in group 06";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 06",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
