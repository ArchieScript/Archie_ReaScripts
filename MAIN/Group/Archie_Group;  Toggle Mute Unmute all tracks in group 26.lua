--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 26
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 26
   * О скрипте:   Переключить Mute Unmute все треки в группе 26
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40829); -- Select all tracks in group 26
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 26";
       else;
           ...
           Undo = "Unmute all tracks in group 26";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 26",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
