--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 30
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 30
   * О скрипте:   Переключить Соло Unsolo все треки в группе 30
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40833); -- Select all tracks in group 30
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 30";
       else;
           ...
           Undo = "Unsolo all tracks in group 30";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 30",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
