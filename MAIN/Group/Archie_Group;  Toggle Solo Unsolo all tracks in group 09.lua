--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 09
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 09
   * О скрипте:   Переключить Соло Unsolo все треки в группе 09
   * GIF:         ---
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 09";
       else;
           ...
           Undo = "Unsolo all tracks in group 09";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 09",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
