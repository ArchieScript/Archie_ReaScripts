--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 20
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 20
   * О скрипте:   Переключить Mute Unmute все треки в группе 20
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40823); -- Select all tracks in group 20
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 20";
       else;
           ...
           Undo = "Unmute all tracks in group 20";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 20",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
