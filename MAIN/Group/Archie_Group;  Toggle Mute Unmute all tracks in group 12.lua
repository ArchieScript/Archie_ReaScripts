--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 12
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 12
   * О скрипте:   Переключить Mute Unmute все треки в группе 12
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40815); -- Select all tracks in group 12
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 12";
       else;
           ...
           Undo = "Unmute all tracks in group 12";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 12",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
