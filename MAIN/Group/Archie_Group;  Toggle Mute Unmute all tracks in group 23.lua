--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 23
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 23
   * О скрипте:   Переключить Mute Unmute все треки в группе 23
   * GIF:         ---
...
--===========================================================================================]]
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 23";
       else;
           ...
           Undo = "Unmute all tracks in group 23";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 23",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
