--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 03
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 03
   * О скрипте:   Переключить Соло Unsolo все треки в группе 03
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40806); -- Select all tracks in group 03
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 03";
       else;
           ...
           Undo = "Unsolo all tracks in group 03";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 03",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
