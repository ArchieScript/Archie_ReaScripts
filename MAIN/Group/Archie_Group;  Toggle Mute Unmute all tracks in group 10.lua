--[[
   * Category:    Group
   * Description: Toggle Mute Unmute all tracks in group 10
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Mute Unmute all tracks in group 10
   * О скрипте:   Переключить Mute Unmute все треки в группе 10
   * GIF:         ---
...
--===========================================================================================]]
    ...
    Arc.Action(40813); -- Select all tracks in group 10
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Mute all tracks in group 10";
       else;
           ...
           Undo = "Unmute all tracks in group 10";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Mute all tracks in group 10",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
