--[[
   * Category:    Group
   * Description: Toggle Solo Unsolo all tracks in group 02
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Toggle Solo Unsolo all tracks in group 02
   * О скрипте:   Переключить Соло Unsolo все треки в группе 02
   * GIF:         ---
...
--===========================================================================================]]
    ...
    package.path = package.path..";"..Way.."/?.lua";Arc=require"Arc_Function_lua";Arc.VersionArc_Function_lua("2.0.8",Way,"")end;---
    --=========================================================================================================▲▲▲▲▲================
    ...
    Arc.Action(40805); -- Select all tracks in group 02
    ---------------------------------------------------
    if SelMaster ~= 0 then;
    ...
    for i = 1,CountSelTrack do;
       ...
       if ON == 1 then;
           ...
           Undo = "Solo all tracks in group 02";
       else;
           ...
           Undo = "Unsolo all tracks in group 02";
       end;
    end;
    -------------------------------------
    ...
    if Undo then;
       ...
       reaper.Undo_EndBlock(" ! No Group / Solo all tracks in group 02",-1);
    end;
    ----
    reaper.PreventUIRefresh(-1);
    -----------
