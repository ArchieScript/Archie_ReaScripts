--[[
   ...
   * Description: Move edit cursor to start of nearest selected item and next in time
   * Author:      Archie
   * Version:     1.02
   * AboutScript: Move edit cursor to start of nearest selected item and next in time
   * О скрипте:   Переместить курсор редактирования в начало ближайшего выбранного элемента и далее к следующему по времени
   * GIF:         ---
    ...
    if z_numb == 1 then;
        ...
        while true do;
            ...
            --if pos ~= curs then;
                ...
                -----------------------------------------
                --при равных положениях переместит назад
                posX = math.abs(curs - pos-0.00000000001);
                ------------------------------------------
                --при равных положениях переместит вперед
                --posX = math.abs(curs - pos);
                ------------------------------
