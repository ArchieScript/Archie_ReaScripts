--[[
   * Category:    View 
   * Description: Layout Large on selected tracks MCP
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Layout Large on selected tracks MCP
   * О скрипте:   Макет Большой на выбранных треках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "ca - Large";
    ...
    reaper.Undo_EndBlock("Layout Large on selected tracks MCP",-1);