--[[
   * Category:    View 
   * Description: Layout Strip on selected tracks MCP
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Layout Strip on selected tracks MCP
   * О скрипте:   Макет полосы на выбранных дорожках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "ea - Strip";
    ...
    reaper.Undo_EndBlock("Layout Strip on selected tracks MCP",-1);