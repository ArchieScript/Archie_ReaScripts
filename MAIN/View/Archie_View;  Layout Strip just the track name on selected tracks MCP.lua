--[[
   * Category:    View 
   * Description: Layout Strip just the track name on selected tracks MCP
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Layout Strip just the track name on selected tracks MCP
   * О скрипте:   Макет полосы только название трека на выбранных треков MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "ee --- Strip Just the track name";
    ...
    reaper.Undo_EndBlock("Layout Strip just the track name on selected tracks MCP",-1);