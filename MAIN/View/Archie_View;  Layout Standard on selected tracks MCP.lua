--[[
   * Category:    View 
   * Description: Layout Standard on selected tracks MCP 
   * Author:      Archie
   * Version:     1.01
   * AboutScript: Layout Standard on selected tracks MCP 
   * О скрипте:   Макет стандартный на выбранных дорожках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "aa - Standard";
    ...
    reaper.Undo_EndBlock("Layout Standard on selected tracks MCP",-1);