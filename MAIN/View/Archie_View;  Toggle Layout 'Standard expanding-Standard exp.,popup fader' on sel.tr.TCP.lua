--[[
   * Category:    View 
   * Description: Toggle Layout 'Standard expanding-Standard exp.,popup fader' on sel.tr.TCP
   * Author:      Archie
   * Version:     1.03
   * AboutScript: Toggle Layout 'Standard expanding-Standard expanding, popup fader' on selected tracks TCP
   * О скрипте:   Переключить Макет "Стандартное расширение - стандартное расширение, всплывающий фейдер" 
   *                                                                         на выбранных треках TCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local UndoName;
    local layoutName;
    local layoutName1 = "af --- Standard expanding, popup fader";
    local layoutName2 = "ae --- Standard expanding";
    ...
    ---
    local Lay, TCP = str:match('(LAYOUTS) (".-")');
    if TCP ~= '"'..layoutName1..'"' then layoutName = layoutName1;
        UndoName = "Layout Standard expanding, popup fader";
    else layoutName = layoutName2;
        UndoName = "Layout Standard expanding";
    end;
    ---
