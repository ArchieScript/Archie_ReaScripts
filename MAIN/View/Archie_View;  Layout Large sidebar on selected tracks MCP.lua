--[[
   * Category:    View 
   * Description: Layout Large sidebar on selected tracks MCP
   * Author:      Archie
   * Version:     1.03
   * AboutScript: Layout Large sidebar on selected tracks MCP
   * О скрипте:   Макет большой боковой панели на выбранных дорожках MCP
...
--===========================================================================================]]
    ...
    local layoutName,Active = "cb --- Large Sidebar";
    ...
    reaper.Undo_EndBlock("Layout Large sidebar on selected tracks MCP",-1);