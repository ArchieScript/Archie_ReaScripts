--[[
   * Category:    View 
   * Description: Layout Standard sidebar on selected tracks MCP
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Layout Standard sidebar on selected tracks MCP
   * О скрипте:   Макет стандартной боковой панели на выбранных дорожках MCP
   * GIF:         http://clck.ru/Ekcq4 -- small
...
--===========================================================================================]]
    ...
    local layoutName,Active = "ab --- Standard Sidebar";
    ...
    reaper.Undo_EndBlock("Layout Standard sidebar on selected tracks MCP",-1);