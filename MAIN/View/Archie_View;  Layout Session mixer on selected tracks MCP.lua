--[[
   * Category:    View 
   * Description: Layout Session mixer on selected tracks MCP
   * Author:      Archie
   * Version:     1.03
   * AboutScript: Layout Session mixer on selected tracks MCP
   * О скрипте:   Макет Сессионный микшер на выбранных треках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "da - Session Mixer";
    ...
    reaper.Undo_EndBlock("Layout Session mixer on selected tracks MCP",-1);