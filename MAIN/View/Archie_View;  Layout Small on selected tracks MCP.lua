--[[
   * Category:    View 
   * Description: Layout Small on selected tracks MCP
   * Author:      Archie
   * Version:     1.0
   * AboutScript: Layout Small on selected tracks MCP
   * О скрипте:   Макет небольшой на выбранных дорожках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "ba - Small";
    ...
    reaper.Undo_EndBlock("Layout Small on selected tracks MCP",-1);