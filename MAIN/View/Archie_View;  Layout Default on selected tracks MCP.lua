--[[
   * Category:    View 
   * Description: Layout Default on selected tracks MCP
   * Author:      Archie
   * Version:     1.02
   * AboutScript: Layout Default on selected tracks MCP
   * О скрипте:   Макет по умолчанию на выбранных дорожках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    reaper.Undo_EndBlock("Layout Default on selected tracks MCP",-1);