--[[
   * Category:    View 
   * Description: Layout Strip full controls on selected tracks MCP
   * Author:      Archie
   * Version:     1.03
   * AboutScript: Layout Strip full controls on selected tracks MCP
   * О скрипте:   Макет полосы полный контроль на выбранных дорожках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "eb --- Strip Full Controls";
    ...
    reaper.Undo_EndBlock("Layout Strip full controls on selected tracks MCP",-1);