--[[
   * Category:    View 
   * Description: Layout Small full meter on selected tracks MCP 
   * Author:      Archie
   * Version:     1.03
   * AboutScript: Layout Small full meter on selected tracks MCP 
   * О скрипте:   Макет малого полного метра на выбранных треках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "bc --- Small Full Meter";
    ...
    reaper.Undo_EndBlock("Layout Small full meter on selected tracks MCP",-1);