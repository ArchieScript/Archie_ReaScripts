--[[
   * Category:    View 
   * Description: Layout Strip meter bridge on selected tracks MCP
   * Author:      Archie
   * Version:     1.03
   * AboutScript: Layout Strip meter bridge on selected tracks MCP
   * О скрипте:   Макет полоса моста метра на выбранных дорожках MCP
   * GIF:         ---
...
--===========================================================================================]]
    ...
    local layoutName,Active = "ed --- Strip Meter Bridge";
    ...
    reaper.Undo_EndBlock("Layout Strip meter bridge on selected tracks MCP",-1);