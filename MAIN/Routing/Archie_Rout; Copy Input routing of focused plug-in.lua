--[[
   ...
   *
   * Category:    Routing
   * Description: Copy Input routing of focused plug-in
   * Author:      Archie
   * Version:     1.01
   * Описание:    Копировать входную маршрутизацию сфокусированного плагина
...
--]]
    ...
    CopyInput_FocusedFX_Pin("Archie_Rout;CopyInputRoutingOfFocusedPlugIn.lua",false);
