--[[
   ...
   *
   * Category:    Routing
   * Description: Copy IO routing of focused plug-in
   * Author:      Archie
   * Version:     1.0
   * Описание:    Копирование маршрутизации ввода-вывода сфокусированного плагина
...
--]]
    ...
    local function CopyInput_FocusedFX_Pin(NameScript,persist);
    ...
    CopyInput_FocusedFX_Pin ("CopyIORoutingOfFocusedPlugIn",false);
    CopyOutput_FocusedFX_Pin("CopyIORoutingOfFocusedPlugIn",false);
