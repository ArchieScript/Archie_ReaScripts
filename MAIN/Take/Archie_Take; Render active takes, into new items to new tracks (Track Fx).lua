--[[
   ...
   *
   * Category:    Take
   * Description: Take; Render active takes, into new items to new tracks (Track Fx)
   * Author:      Archie
   * Version:     1.02
   * Описание:    Рендер активных тейков в новые элементы на новые треки (Track Fx)
...
--]]
    ...
    reaper.PreventUIRefresh(-1);
    reaper.Undo_EndBlock('Render active takes, into new items to new tracks (Track Fx)',-1);
