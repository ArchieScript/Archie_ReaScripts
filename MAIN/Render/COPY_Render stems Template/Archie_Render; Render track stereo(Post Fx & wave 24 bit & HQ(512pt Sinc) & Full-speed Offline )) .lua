--[[
   ...
   *
   * Category:    Render
   * Description: Render track stereo(Post Fx & wave 24 bit & HQ(512pt Sinc) & Full-speed Offline )
...
--]]
    ...
    local TITLE = "Render track (Post Fx & wave 24 bit & HQ(512pt Sinc) & Full-speed Offline )"
